              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    type="text"
                    id="name"
                    className="w-full text-black bg-white border border-gray-600 rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
